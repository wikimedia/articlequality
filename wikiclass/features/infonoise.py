...
def score(text, language=languages.get('en-us')):
	"""
	...
	# Filter stopwords
	nonstops = list(language.filter_stopwords(words, stopwords))
	
	# Stem words
	stemmed_nonstops = list(language.stem_words(words, stem))
